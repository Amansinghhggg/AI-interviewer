      ...
      <div className="w-full max-w-[1600px] mx-auto p-4 md:p-10 space-y-8">
        ...
        >
          <div className="relative group">
            <div className="w-32 h-32 rounded-full border-2 border-[var(--color-primary-md3)] p-1 bg-[var(--color-background)] overflow-hidden">
            ...
            {/* Dummy edit button */}
            <button className="absolute bottom-1 right-1 bg-[var(--color-primary-md3)] text-white p-2 rounded-full hover:brightness-110 active:scale-95 transition-all shadow-lg flex items-center justify-center">
